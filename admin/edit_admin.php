...
$data = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM admin WHERE id_admin = $admin_id"));
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($_POST['password'])) {
        ...
        mysqli_query($koneksi, "UPDATE admin SET username = '$username', password = '$password', fullname = '$fullname' WHERE id_admin = $admin_id");
    } else {
        mysqli_query($koneksi, "UPDATE admin SET username = '$username', fullname = '$fullname' WHERE id_admin = $admin_id");
    }
